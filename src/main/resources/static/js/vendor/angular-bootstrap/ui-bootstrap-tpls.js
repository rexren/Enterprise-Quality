 ...
 */
  ...
  return {
    ...
    link:function (originalScope, element, attrs, modelCtrl) {
      ...
      //focus时触发一次过滤 edit by sweetyx
      element.bind('focus', function (evt) {
          var fn = modelCtrl.$parsers[0];
          if(typeof fn==="function"){
            if(typeof modelCtrl.$viewValue==="undefined" || modelCtrl.$viewValue===null || modelCtrl.$viewValue==="")
              modelCtrl.$setViewValue("");
            fn(modelCtrl.$viewValue);
          }
      });
...
//修改typeahead的最大下拉高度max-height:300px;  edit by sweetyx
angular.module("template/typeahead/typeahead-popup.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/typeahead/typeahead-popup.html",
    "<ul class=\"dropdown-menu\" ng-show=\"isOpen() && !moveInProgress\" ng-style=\"{top: position().top+'px', left: position().left+'px'}\" style=\"display: block;max-height:300px;overflow-y:auto;\" role=\"listbox\" aria-hidden=\"{{!isOpen()}}\">\n" +
