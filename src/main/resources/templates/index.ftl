...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <#--<div class="user-panel">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="#"><i class="fa fa-link"></i> <span>型检国标</span></a></li>
                <li class="active"><a href="#"><i class="fa fa-link"></i> <span>3C</span></a></li>
                <li class="active"><a href="#"><i class="fa fa-link"></i> <span>双证</span></a></li>
            </ul>
            <!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
                                    ...
                                    <div class="col-sm-12">
                                        <table id="example2" class="table table-bordered table-hover dataTable"
                                            ...
                                            <tr>
                                                ...
                                                <th rowspan="1" colspan="1">负责人(s)</th>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2017 <a href="www.ga.hikvision.com">Hikvision</a>.</strong> All rights reserved.
    </footer>
