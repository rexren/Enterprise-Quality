...
public class TypeInspectionService {
     ...
     * @return void
     */
    public void importInspectionList(List<TypeInspection> inspections) throws IOException {
        ...
        for (TypeInspection t : inspections) {

            if (StringUtils.isNotBlank(t.getDocNo())) {
                SearchEntry entry = new SearchEntry();
                entry.setId(t.getDocNo());
                entry.setTitle(t.getName());
                entry.setDescription(t.getModel());
                entry.setRemark(t.getRemarks());
